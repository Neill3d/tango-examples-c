...
JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_motiontracking_TangoJNINative_setupArchiveDir(
        JNIEnv* env, jobject pThis, jstring str) {

    jboolean isCopy;
    const char *internalStoragePath;
    internalStoragePath = env->GetStringUTFChars(str, &isCopy);
    ...
    app.OnSetupArchiveDir(internalStoragePath);

    env->ReleaseStringUTFChars(str, internalStoragePath);
}
...
JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_motiontracking_TangoJNINative_onTouchEvent(
...
JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_motiontracking_TangoJNINative_onButtonToggleClicked(
        JNIEnv*, jobject) {
    app.OnButtonToggleClicked();
}

JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_motiontracking_TangoJNINative_onButtonResetClicked(
        JNIEnv*, jobject) {
    app.OnButtonResetClicked();
}

JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_motiontracking_TangoJNINative_onButtonRecordClicked(
        JNIEnv*, jobject) {
    app.OnButtonRecordClicked();
}
